    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                ...
                <asp:Label CssClass="ml-5" ID="Label1" runat="server" Text="Project : "></asp:Label>
                <asp:Label CssClass="ml-5" ID="lbl_Proj" runat="server"></asp:Label>

                <asp:Label CssClass="ml-5" ID="Label2" runat="server" Text="Project Name : "></asp:Label>
                <asp:Label ID="lbl_ProjName" CssClass="ml-5" runat="server"></asp:Label>

                <asp:Label CssClass="ml-5" ID="Label3" runat="server" Text="Version : "></asp:Label>
                <asp:Label ID="lbl_Version" CssClass="ml-5" runat="server"></asp:Label>
