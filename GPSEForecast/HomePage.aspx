...
<%--                        <div class="row">
                            <div class="col-md-2">
                                <input type="checkbox" id="version_checkbox" checked data-toggle="toggle" data-on="New" data-off="Existing" data-onstyle="info" data-offstyle="info" />
                            </div>
                            <div class="col-md-10">
                                <div id="version_text_grp" class="input-group  input-group-sm mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">Version</div>
                                    </div>
                                    <asp:TextBox runat="server" ID="txt_version" type="text" class="form-control" />
                                </div>

                                <div id="version_drp_grp" class="input-group  input-group-sm mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">Version</div>
                                    </div>
                                    <asp:DropDownList runat="server" ID="drp_Version" class="custom-select"></asp:DropDownList>
                                </div>
                            </div>
                        </div>--%>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#version_text_grp').show();
            $('#txt_version').show();

            $('#drp_Version').hide();
            $('#version_drp_grp').hide();
        ...
        //    }
        //    else {
        //        $('#version_text_grp').hide();
        //        $('#txt_version').hide();

        //        $('#drp_Version').show();
        //        $('#version_drp_grp').show();
        //    }
        //});
